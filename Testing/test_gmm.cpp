...
protected:
    ...
    static void TestExpectationStep() {
        ...
        result.weights = Eigen::Vector3d(0.3333333333333333, 0.3333333333333333, 0.3333333333333333);
    ...
    static void TestExpectationStep_SecondCase() {
        ...
        result.weights = Eigen::Vector3d(0.12309068557448444, 0.30756460120925033, 0.5693447132162652);
